...
<head>
  ...
  <title>Painel de Controle - Adicionar Produtos</title>
                          ...
                          <tr>
                            ...
                            <td>
                              <form action="" method="post">
                                <input type="hidden" name="shepp-firewall" value="<?= $produto->id ?>">
                                <input type="hidden" name="idDelete" value="<?= $produto->valor ?>">
